...
import landing from '@/data/town-landings/basildon-lofts.json';
import {
  breadcrumbSchema,
  faqSchema,
  JsonLd,
...
export default function BasildonLoftConversionsPage() {
  return (
    <>
      <JsonLd
      ...
      <JsonLd
        data={breadcrumbSchema([
          ...
          { name: 'Basildon', path: '/loft-conversions/essex/basildon' },
        ])}
      />
