...
import landing from '@/data/town-landings/harlow-lofts.json';
import {
  breadcrumbSchema,
  faqSchema,
  JsonLd,
...
export default function HarlowLoftConversionsPage() {
  return (
    <>
      <JsonLd
      ...
      <JsonLd
        data={breadcrumbSchema([
          ...
          { name: 'Harlow', path: '/loft-conversions/essex/harlow' },
        ])}
      />
