...
import landing from '@/data/town-landings/epping-lofts.json';
import {
  breadcrumbSchema,
  faqSchema,
  JsonLd,
...
export default function EppingLoftConversionsPage() {
  return (
    <>
      <JsonLd
      ...
      <JsonLd
        data={breadcrumbSchema([
          ...
          { name: 'Epping', path: '/loft-conversions/essex/epping' },
        ])}
      />
