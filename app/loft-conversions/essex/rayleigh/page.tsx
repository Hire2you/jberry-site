...
import landing from '@/data/town-landings/rayleigh-lofts.json';
import {
  breadcrumbSchema,
  faqSchema,
  JsonLd,
...
export default function RayleighLoftConversionsPage() {
  return (
    <>
      <JsonLd
      ...
      <JsonLd
        data={breadcrumbSchema([
          ...
          { name: 'Rayleigh', path: '/loft-conversions/essex/rayleigh' },
        ])}
      />
