...
import landing from '@/data/town-landings/chigwell-lofts.json';
import {
  breadcrumbSchema,
  faqSchema,
  JsonLd,
...
export default function ChigwellLoftConversionsPage() {
  return (
    <>
      <JsonLd
      ...
      <JsonLd
        data={breadcrumbSchema([
          ...
          { name: 'Chigwell', path: '/loft-conversions/essex/chigwell' },
        ])}
      />
