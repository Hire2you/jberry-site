...
import landing from '@/data/town-landings/brentwood-lofts.json';
import {
  breadcrumbSchema,
  faqSchema,
  JsonLd,
...
export default function BrentwoodLoftConversionsPage() {
  return (
    <>
      <JsonLd
      ...
      <JsonLd
        data={breadcrumbSchema([
          ...
          { name: 'Brentwood', path: '/loft-conversions/essex/brentwood' },
        ])}
      />
