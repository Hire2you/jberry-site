...
import landing from '@/data/town-landings/saffron-walden-lofts.json';
import {
  breadcrumbSchema,
  faqSchema,
  JsonLd,
...
export default function SaffronWaldenLoftConversionsPage() {
  return (
    <>
      <JsonLd
      ...
      <JsonLd
        data={breadcrumbSchema([
          ...
          { name: 'Saffron Walden', path: '/loft-conversions/essex/saffron-walden' },
        ])}
      />
