...
import landing from '@/data/town-landings/maldon-lofts.json';
import {
  breadcrumbSchema,
  faqSchema,
  JsonLd,
...
export default function MaldonLoftConversionsPage() {
  return (
    <>
      <JsonLd
      ...
      <JsonLd
        data={breadcrumbSchema([
          ...
          { name: 'Maldon', path: '/loft-conversions/essex/maldon' },
        ])}
      />
