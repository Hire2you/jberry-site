...
import landing from '@/data/town-landings/wickford-lofts.json';
import {
  breadcrumbSchema,
  faqSchema,
  JsonLd,
...
export default function WickfordLoftConversionsPage() {
  return (
    <>
      <JsonLd
      ...
      <JsonLd
        data={breadcrumbSchema([
          ...
          { name: 'Wickford', path: '/loft-conversions/essex/wickford' },
        ])}
      />
