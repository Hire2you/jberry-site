...
import landing from '@/data/town-landings/great-dunmow-lofts.json';
import {
  breadcrumbSchema,
  faqSchema,
  JsonLd,
...
export default function GreatDunmowLoftConversionsPage() {
  return (
    <>
      <JsonLd
      ...
      <JsonLd
        data={breadcrumbSchema([
          ...
          { name: 'Great Dunmow', path: '/loft-conversions/essex/great-dunmow' },
        ])}
      />
