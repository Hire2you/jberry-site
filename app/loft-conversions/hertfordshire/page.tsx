...
import hub from '@/data/county-hubs/loft-hertfordshire.json';
...
export default function HertfordshireLoftConversionsPage() {
  return (
    <>
      <JsonLd
      ...
      <JsonLd
        data={breadcrumbSchema([
          ...
          { name: 'Hertfordshire', path: '/loft-conversions/hertfordshire' },
        ])}
      />
