...
import landing from '@/data/town-landings/gravesend-lofts.json';
import {
  breadcrumbSchema,
  faqSchema,
  JsonLd,
...
export default function GravesendLoftConversionsPage() {
  return (
    <>
      <JsonLd
      ...
      <JsonLd
        data={breadcrumbSchema([
          ...
          { name: 'Gravesend', path: '/loft-conversions/kent/gravesend' },
        ])}
      />
