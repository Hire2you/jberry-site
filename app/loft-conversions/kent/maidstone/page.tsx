...
import landing from '@/data/town-landings/maidstone-lofts.json';
import {
  breadcrumbSchema,
  faqSchema,
  JsonLd,
...
export default function MaidstoneLoftConversionsPage() {
  return (
    <>
      <JsonLd
      ...
      <JsonLd
        data={breadcrumbSchema([
          ...
          { name: 'Maidstone', path: '/loft-conversions/kent/maidstone' },
        ])}
      />
