...
import landing from '@/data/town-landings/dartford-lofts.json';
import {
  breadcrumbSchema,
  faqSchema,
  JsonLd,
...
export default function DartfordLoftConversionsPage() {
  return (
    <>
      <JsonLd
      ...
      <JsonLd
        data={breadcrumbSchema([
          ...
          { name: 'Dartford', path: '/loft-conversions/kent/dartford' },
        ])}
      />
