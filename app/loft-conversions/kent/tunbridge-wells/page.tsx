...
import landing from '@/data/town-landings/tunbridge-wells-lofts.json';
import {
  breadcrumbSchema,
  faqSchema,
  JsonLd,
...
export default function TunbridgeWellsLoftConversionsPage() {
  return (
    <>
      <JsonLd
      ...
      <JsonLd
        data={breadcrumbSchema([
          ...
          { name: 'Tunbridge Wells', path: '/loft-conversions/kent/tunbridge-wells' },
        ])}
      />
