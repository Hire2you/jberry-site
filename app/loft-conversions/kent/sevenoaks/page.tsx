...
import landing from '@/data/town-landings/sevenoaks-lofts.json';
import {
  breadcrumbSchema,
  faqSchema,
  JsonLd,
...
export default function SevenoaksLoftConversionsPage() {
  return (
    <>
      <JsonLd
      ...
      <JsonLd
        data={breadcrumbSchema([
          ...
          { name: 'Sevenoaks', path: '/loft-conversions/kent/sevenoaks' },
        ])}
      />
