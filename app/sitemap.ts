...
export default async function sitemap(): Promise<MetadataRoute.Sitemap> {
  ...
  const countyHubs = [
    ...
    {url: `${site.domain}/loft-conversions/kent`, changeFrequency: 'monthly' as const},
    {url: `${site.domain}/loft-conversions/hertfordshire`, changeFrequency: 'monthly' as const},
    {url: `${site.domain}/extensions/essex`, changeFrequency: 'monthly' as const},
    {url: `${site.domain}/extensions/london`, changeFrequency: 'monthly' as const},
    {url: `${site.domain}/extensions/kent`, changeFrequency: 'monthly' as const},
    {url: `${site.domain}/extensions/hertfordshire`, changeFrequency: 'monthly' as const},
    ...
    {url: `${site.domain}/extensions/essex/buckhurst-hill`, changeFrequency: 'monthly' as const},
    {url: `${site.domain}/extensions/essex/great-dunmow`, changeFrequency: 'monthly' as const},
    {url: `${site.domain}/loft-conversions/essex/epping`, changeFrequency: 'monthly' as const},
    {url: `${site.domain}/loft-conversions/essex/chigwell`, changeFrequency: 'monthly' as const},
    {url: `${site.domain}/loft-conversions/essex/harlow`, changeFrequency: 'monthly' as const},
    {url: `${site.domain}/loft-conversions/essex/brentwood`, changeFrequency: 'monthly' as const},
    {url: `${site.domain}/loft-conversions/essex/great-dunmow`, changeFrequency: 'monthly' as const},
    {url: `${site.domain}/loft-conversions/essex/wickford`, changeFrequency: 'monthly' as const},
    {url: `${site.domain}/loft-conversions/essex/rayleigh`, changeFrequency: 'monthly' as const},
    {url: `${site.domain}/loft-conversions/essex/saffron-walden`, changeFrequency: 'monthly' as const},
    {url: `${site.domain}/loft-conversions/essex/ongar`, changeFrequency: 'monthly' as const},
    {url: `${site.domain}/loft-conversions/essex/basildon`, changeFrequency: 'monthly' as const},
    {url: `${site.domain}/loft-conversions/essex/maldon`, changeFrequency: 'monthly' as const},
    {url: `${site.domain}/extensions/london/woodford`, changeFrequency: 'monthly' as const},
    {url: `${site.domain}/extensions/london/wanstead`, changeFrequency: 'monthly' as const},
    {url: `${site.domain}/extensions/london/chingford`, changeFrequency: 'monthly' as const},
    {url: `${site.domain}/extensions/london/walthamstow`, changeFrequency: 'monthly' as const},
    {url: `${site.domain}/extensions/london/enfield`, changeFrequency: 'monthly' as const},
    {url: `${site.domain}/loft-conversions/kent/sevenoaks`, changeFrequency: 'monthly' as const},
    {url: `${site.domain}/loft-conversions/kent/bromley`, changeFrequency: 'monthly' as const},
    {url: `${site.domain}/loft-conversions/kent/tunbridge-wells`, changeFrequency: 'monthly' as const},
    {url: `${site.domain}/loft-conversions/kent/maidstone`, changeFrequency: 'monthly' as const},
    {url: `${site.domain}/loft-conversions/kent/dartford`, changeFrequency: 'monthly' as const},
    {url: `${site.domain}/loft-conversions/kent/gravesend`, changeFrequency: 'monthly' as const},
    {url: `${site.domain}/extensions/kent/sevenoaks`, changeFrequency: 'monthly' as const},
    {url: `${site.domain}/extensions/kent/tunbridge-wells`, changeFrequency: 'monthly' as const},
    {url: `${site.domain}/extensions/kent/orpington`, changeFrequency: 'monthly' as const},
    {url: `${site.domain}/extensions/hertfordshire/bishops-stortford`, changeFrequency: 'monthly' as const},
    {url: `${site.domain}/extensions/hertfordshire/sawbridgeworth`, changeFrequency: 'monthly' as const},
  ]
  ...
  return [
    ...
    {url: `${site.domain}/blog/planning-permission-and-building-regulations`, changeFrequency: 'monthly'},
    {url: `${site.domain}/blog/article-4-directions-explained`, changeFrequency: 'monthly'},
    {url: `${site.domain}/blog/extending-in-a-conservation-area`, changeFrequency: 'monthly'},
    {url: `${site.domain}/blog/can-you-extend-in-the-green-belt`, changeFrequency: 'monthly'},
    {url: `${site.domain}/blog/party-wall-act-explained`, changeFrequency: 'monthly'},
    {url: `${site.domain}/blog/building-regulations-vs-planning-permission`, changeFrequency: 'monthly'},
    {url: `${site.domain}/blog/lawful-development-certificates`, changeFrequency: 'monthly'},
    {url: `${site.domain}/blog/flood-risk-and-home-building-projects`, changeFrequency: 'monthly'},
    {url: `${site.domain}/blog/house-extension-mistakes`, changeFrequency: 'monthly'},
    {url: `${site.domain}/blog/open-plan-living-steel-beams`, changeFrequency: 'monthly'},
    ...blogPages,
