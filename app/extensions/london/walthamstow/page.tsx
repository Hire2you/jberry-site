...
import landing from '@/data/town-landings/walthamstow-extensions.json';
import {
  breadcrumbSchema,
  faqSchema,
  JsonLd,
...
export default function WalthamstowExtensionsPage() {
  return (
    <>
      <JsonLd
      ...
      <JsonLd
        data={breadcrumbSchema([
          ...
          { name: 'Walthamstow', path: '/extensions/london/walthamstow' },
        ])}
      />
