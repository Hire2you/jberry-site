...
import landing from '@/data/town-landings/chingford-extensions.json';
import {
  breadcrumbSchema,
  faqSchema,
  JsonLd,
...
export default function ChingfordExtensionsPage() {
  return (
    <>
      <JsonLd
      ...
      <JsonLd
        data={breadcrumbSchema([
          ...
          { name: 'Chingford', path: '/extensions/london/chingford' },
        ])}
      />
