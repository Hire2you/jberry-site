...
import landing from '@/data/town-landings/wanstead-extensions.json';
import {
  breadcrumbSchema,
  faqSchema,
  JsonLd,
...
export default function WansteadExtensionsPage() {
  return (
    <>
      <JsonLd
      ...
      <JsonLd
        data={breadcrumbSchema([
          ...
          { name: 'Wanstead', path: '/extensions/london/wanstead' },
        ])}
      />
