...
import landing from '@/data/town-landings/woodford-extensions.json';
import {
  breadcrumbSchema,
  faqSchema,
  JsonLd,
...
export default function WoodfordExtensionsPage() {
  return (
    <>
      <JsonLd
      ...
      <JsonLd
        data={breadcrumbSchema([
          ...
          { name: 'Woodford', path: '/extensions/london/woodford' },
        ])}
      />
