...
import landing from '@/data/town-landings/enfield-extensions.json';
import {
  breadcrumbSchema,
  faqSchema,
  JsonLd,
...
export default function EnfieldExtensionsPage() {
  return (
    <>
      <JsonLd
      ...
      <JsonLd
        data={breadcrumbSchema([
          ...
          { name: 'Enfield', path: '/extensions/london/enfield' },
        ])}
      />
