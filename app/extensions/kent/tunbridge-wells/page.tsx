...
import landing from '@/data/town-landings/tunbridge-wells-extensions.json';
import {
  breadcrumbSchema,
  faqSchema,
  JsonLd,
...
export default function TunbridgeWellsExtensionsPage() {
  return (
    <>
      <JsonLd
      ...
      <JsonLd
        data={breadcrumbSchema([
          ...
          { name: 'Tunbridge Wells', path: '/extensions/kent/tunbridge-wells' },
        ])}
      />
