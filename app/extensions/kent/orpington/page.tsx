...
import landing from '@/data/town-landings/orpington-extensions.json';
import {
  breadcrumbSchema,
  faqSchema,
  JsonLd,
...
export default function OrpingtonExtensionsPage() {
  return (
    <>
      <JsonLd
      ...
      <JsonLd
        data={breadcrumbSchema([
          ...
          { name: 'Orpington', path: '/extensions/kent/orpington' },
        ])}
      />
