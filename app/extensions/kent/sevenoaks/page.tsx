...
import landing from '@/data/town-landings/sevenoaks-extensions.json';
import {
  breadcrumbSchema,
  faqSchema,
  JsonLd,
...
export default function SevenoaksExtensionsPage() {
  return (
    <>
      <JsonLd
      ...
      <JsonLd
        data={breadcrumbSchema([
          ...
          { name: 'Sevenoaks', path: '/extensions/kent/sevenoaks' },
        ])}
      />
