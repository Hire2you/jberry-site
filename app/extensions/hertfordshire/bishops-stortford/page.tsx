...
import landing from '@/data/town-landings/bishops-stortford-extensions.json';
import {
  breadcrumbSchema,
  faqSchema,
  JsonLd,
...
export default function BishopsStortfordExtensionsPage() {
  return (
    <>
      <JsonLd
      ...
      <JsonLd
        data={breadcrumbSchema([
          ...
          { name: 'Bishop\'s Stortford', path: '/extensions/hertfordshire/bishops-stortford' },
        ])}
      />
