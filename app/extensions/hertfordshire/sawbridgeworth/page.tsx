...
import landing from '@/data/town-landings/sawbridgeworth-extensions.json';
import {
  breadcrumbSchema,
  faqSchema,
  JsonLd,
...
export default function SawbridgeworthExtensionsPage() {
  return (
    <>
      <JsonLd
      ...
      <JsonLd
        data={breadcrumbSchema([
          ...
          { name: 'Sawbridgeworth', path: '/extensions/hertfordshire/sawbridgeworth' },
        ])}
      />
