...
import landing from '@/data/town-landings/great-dunmow-extensions.json';
import {
  breadcrumbSchema,
  faqSchema,
  JsonLd,
...
export default function GreatDunmowExtensionsPage() {
  return (
    <>
      <JsonLd
      ...
      <JsonLd
        data={breadcrumbSchema([
          ...
          { name: 'Great Dunmow', path: '/extensions/essex/great-dunmow' },
        ])}
      />
