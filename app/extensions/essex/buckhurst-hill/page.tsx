...
import landing from '@/data/town-landings/buckhurst-hill-extensions.json';
import {
  breadcrumbSchema,
  faqSchema,
  JsonLd,
...
export default function BuckhurstHillExtensionsPage() {
  return (
    <>
      <JsonLd
      ...
      <JsonLd
        data={breadcrumbSchema([
          ...
          { name: 'Essex', path: '/extensions/essex' },
          { name: 'Buckhurst Hill', path: '/extensions/essex/buckhurst-hill' },
        ])}
      />
